package org.example.television_problem.view.waiting_room;
...
import org.example.television_problem.view_model.waiting_room.WaitingRoomViewModel;

public class WaitingRoomView implements FxmlView<WaitingRoomViewModel> {
    Integer lastId = 0;
    @FXML
    ...
    @FXML
    private VBox squaresContainer; // O contêiner onde os quadrados serão exibidos
